...
CREATE POLICY "Allow insert/update students admin" ON students FOR ALL USING (true);
CREATE POLICY "Allow read timetable" ON timetable_slots FOR SELECT USING (true);
CREATE POLICY "Allow read announcements" ON announcements FOR SELECT USING (true);
CREATE POLICY "Allow read materials" ON materials FOR SELECT USING (true);
CREATE POLICY "Allow read doubts" ON doubts FOR SELECT USING (true);
